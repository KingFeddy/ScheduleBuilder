...
export const unnamedCourse: CourseResponse = { course_code: 'CS280', title: null, credits: 3 }
...
export const unnamedGer: GerGroup = { prefix: 'HUM', courses: [{ code: 'HUM101', title: null }] }
